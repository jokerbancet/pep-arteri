...
<head>
    ...
    <link type="text/css" rel="stylesheet" href="<?php echo base_url('/public/css/login1.css') ?>" />
    <link href="<?php echo base_url('/public/images2/logo-transparent.png') ?>" rel="icon" />
</head>
<body>
...
<div class="container" id=logindiv>
	<div class="row">
    	<div class="container" id="formContainer">
		  ...
		  <p align="center"><img src="<?php echo base_url("/public/images2/logo-vertikal.png");?>" class="img-responsive" width="70%"></p>
            ...
            <div class="mb-2">
                <input type="text" class="form-control" name="username" id="loginEmail" placeholder="Masukan username..." required autofocus>
            </div>
            <div>
                <input type="password" class="form-control" name="password" id="loginPass" placeholder="Masukan katasandi" required>
            </div>
            <button class="btn btn-lg btn-primary btn-block" type="submit">Login</button>
            <br><p align="center">Arteri PEP Bandung</p>
          </form>
